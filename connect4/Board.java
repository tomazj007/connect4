...
public class Board {
    ...
    public static final int ROWS = 6, COLUMNS = 7, MARK_BLACK= 2, MARK_RED= 1, UNMARKED=0 ;
    ...
    public int mark(int col, int mark) throws IllegalArgumentException {
    ...
    public void set(int col, int mark) throws IllegalArgumentException {
